...
**沒驗到的一格（誠實記錄）**：「重新判讀 → 立刻成功」這個組合沒看到。
2026-08-19 21:00 起 Gemini 持續回 503 `high demand`，連試六次都是
（每次頁面仍正常回 200，等於又驗了一次回落）。那條路與「首次判讀成功」
走完全相同的程式碼，而後者當天成功過多次（photoId=3/4/5/6）。
